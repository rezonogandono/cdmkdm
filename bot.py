...
WELCOME_TEXTS = {
    "ru": (
        ...
        f"{E_BRIEF} Avito - Мы специализированный сервис по обеспечению безопасности вне биржевых сделок.\n\n"
    ...
    "en": (
        f"Welcome {E_WAVE}\n\n"
        f"{E_BRIEF} Avito - We are a specialized service for securing OTC deals.\n\n"
    ...
    "ar": (
        f"مرحباً {E_WAVE}\n\n"
        f"{E_BRIEF} Avito - نحن خدمة متخصصة في تأمين الصفقات خارج البورصة.\n\n"
    ...
    "zh": (
        f"欢迎 {E_WAVE}\n\n"
        f"{E_BRIEF} Avito - 我们是专业的场外交易安全服务商。\n\n"
        f"{E_SPARK} 自动化执行算法。\n"
        f"{E_LIGHT} 速度与自动化。\n"
        f"{E_CARD} 便捷快速的资金提取。\n\n"
        "• 服务佣金：1%\n"
